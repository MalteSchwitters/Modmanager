...
public class TexturedPanel extends JPanel {
	 ...
	 */
	public TexturedPanel(final Color foreground, final Color background) {
		super();
	 ...
	 * texture map and consisting of the given foreground and background colors.
	 */
	public TexturedPanel(final Color foreground, final Color background, final boolean[][] texture,
			final int scale) {
		super();
		ourDefaultForeground = (foreground != null ? foreground : Color.white);
		ourDefaultBackground = (background != null ? background : getBackground());
	 ...
	 */
	public TexturedPanel(final Image texture) {
		super();
		ourDefaultForeground = Color.white;
		ourDefaultBackground = getBackground();
	 ...
	 */
	public TexturedPanel(final Icon textureIcon) {
		super();
		ourDefaultForeground = Color.white;
		ourDefaultBackground = getBackground();
	 ...
	 */
	public void setTexture(final Color foreground, final Color background,
			final boolean[][] texture) {
	 ...
	 */
	public void setTexture(final Color foreground, final Color background,
			final boolean[][] texture, final int scale) {
		setupTexturePainter(foreground, background, texture, scale);
	}

	/**
	 * Sets up this TexturedPanel to paint a striped background consisting of
	 * the provided colors.
	 */
	public void setTextureColors(final Color foreground, final Color background) {
	 ...
	 */
	public void setTextureImage(final Image texture) {
		if (texture != null) {
			setupImagePainter(texture);
		}
		else {
	...
	/**
	 * Sets up this TexturedPanel to paint a tiled background consisting of the
	 * provided icon. If the icon is null, the background will revert to a
	 * striped texture consisting of the last known colors.
	 */
	public void setTextureIcon(final Icon textureIcon) {
		if (textureIcon != null) {
			setupIconPainter(textureIcon);
		}
		else {
	 ...
	 */
	private void setupDefaultPainter(final Color foreground, final Color background) {
		if (foreground == null || background == null) {
			ourPainter = null;
			return;
		}
	 ...
	 */
	private void setupTexturePainter(final Color foreground, final Color background,
			final boolean[][] texture, int scale) {
		...
		BufferedImage buff = new BufferedImage(w * scale, h * scale,
	 ...
	 */
	private void setupImagePainter(final Image texture) {
		if (texture == null) {
			ourPainter = null;
			return;
		}
	 ...
	 */
	private void setupIconPainter(final Icon texture) {
		if (texture == null) {
			ourPainter = null;
			return;
		}
