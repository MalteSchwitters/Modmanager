 ...
 */
public class Flowlayout4Scrollpane extends FlowLayout {
	 ...
	 *            the alignment value
	 */
	public Flowlayout4Scrollpane(final int align) {
		super(align);
	}
	 ...
	 */
	public Flowlayout4Scrollpane(final int align, final int hgap, final int vgap) {
